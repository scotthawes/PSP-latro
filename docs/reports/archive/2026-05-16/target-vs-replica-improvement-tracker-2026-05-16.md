...
- `docs/reports/archive/2026-05-16/target-vs-psp-comparison-2026-05-16.md`
- `docs/reports/ui-comparison-issue-collation.md`
...
- If a difference is already covered by an issue doc in `docs/issues/ui-comparison/`, link it there instead of duplicating the full investigation.
