...
- docs/plans/ui-parity-test-plan.md

## Issue Index

1. Garbled Text Rendering
   - File: docs/issues/ui-parity/issue-01-font-rendering-garbled-text.md
   - Priority: P0
   - Affects: Pregame, Ingame
2. Missing UI Assets and Fallback Visuals
   - File: docs/issues/ui-parity/issue-02-missing-ui-assets-and-fallbacks.md
   - Priority: P0
   - Affects: Pregame, Ingame
3. Blind Panel Style Mismatch
   - File: docs/issues/ui-parity/issue-03-blind-panel-visual-parity.md
   - Priority: P1
   - Affects: Pregame
4. Action Button Style and Alignment Drift
   - File: docs/issues/ui-parity/issue-04-button-style-and-layout.md
   - Priority: P1
   - Affects: Pregame, Ingame
5. Background Depth and Atmosphere Gap
   - File: docs/issues/ui-parity/issue-05-background-depth-and-texture.md
   - Priority: P1
   - Affects: Pregame, Ingame
6. Debug Overlay Visible in Gameplay Captures
   - File: docs/issues/ui-parity/issue-06-debug-overlay-in-captures.md
   - Priority: P1
   - Affects: Pregame, Ingame
7. Card Fan Layout and Spacing Mismatch
   - File: docs/issues/ui-parity/issue-07-card-fan-layout-and-spacing.md
   - Priority: P2
   - Affects: Ingame
8. HUD Hierarchy and Legibility Regression
   - File: docs/issues/ui-parity/issue-08-hud-hierarchy-and-legibility.md
   - Priority: P1
   - Affects: Pregame, Ingame
9. Deck Widget Scale and Placement Difference
   - File: docs/issues/ui-parity/issue-09-deck-widget-scale-placement.md
   - Priority: P2
   - Affects: Ingame
10. Global Composition and Density Drift
   - File: docs/issues/ui-parity/issue-10-global-spacing-composition.md
   - Priority: P1
   - Affects: Pregame, Ingame
11. Shop Item Rendering Fidelity Regression
   - File: docs/issues/ui-parity/issue-11-shop-item-render-fidelity-regression.md
   - Priority: P1
   - Affects: Shop
...
- End-to-end test plan: docs/plans/ui-parity-test-plan.md
