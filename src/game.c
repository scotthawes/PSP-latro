...
struct JokerType g_joker_types[JOKER_TYPE_COUNT] = {
    ...
    { JOKER_TYPE_FOUR_FINGERS     ,"Four Fingers",          7, JOKER_RARITY_UNCOMMON, true , 6, 6, { "All #5Flushes#- and #5Straights#-", "can be made with 4 cards", "", "", "", ""}},
    ...
    { JOKER_TYPE_LOYALTY_CARD     ,"Loyalty Card",          5, JOKER_RARITY_UNCOMMON, true , 4, 2, { "#c#1x4#- Mult every", "#56#- hands played", "", "#j remaining", "", ""}},
    ...
    { JOKER_TYPE_STEEL_JOKER      ,"Steel Joker",           7, JOKER_RARITY_UNCOMMON, true , 7, 2, { "Gives #c#1x0.2#- Mult for each", "#5Steel Card#- in your", "#5full deck#-", "(Currently #c#1x#j#- Mult)", "", ""}},
    ...
    { JOKER_TYPE_EGG              ,"Egg",                   4, JOKER_RARITY_COMMON,   true , 0, 10,{ "Gains #5$3#- of", "#5sell value#-", "at end of round", "", "", ""}},
    ...
    { JOKER_TYPE_BLACKBOARD       ,"Blackboard",            6, JOKER_RARITY_UNCOMMON, true , 2, 10,{ "#c#1x3#- Mult if", "all held cards are", "#5Spades#- or #5Clubs#-", "", "", ""}},
    { JOKER_TYPE_RUNNER           ,"Runner",                5, JOKER_RARITY_COMMON,   true , 3, 10,{ "Gains #3+15#- Chips", "if played hand", "contains a #5Straight#-", "", "", ""}},
    ...
    { JOKER_TYPE_SIXTH_SENSE      ,"Sixth Sense",           6, JOKER_RARITY_UNCOMMON, true , 8, 10,{ "If #5first hand#-", "is a single #56#-,", "create #5Spectral#- card", "", "", ""}},
    { JOKER_TYPE_CONSTELLATION    ,"Constellation",         6, JOKER_RARITY_UNCOMMON, true , 9, 10,{ "Gains #c#1x0.1#- Mult", "each time a", "#5Planet#- card is used", "", "", ""}},
    ...
    { JOKER_TYPE_CARD_SHARP       ,"Card Sharp",            6, JOKER_RARITY_UNCOMMON, true , 6, 11,{ "#c#1x3#- Mult if", "#5poker hand#- has", "been played this round", "", "", ""}},
    { JOKER_TYPE_RED_CARD         ,"Red Card",              5, JOKER_RARITY_COMMON,   true , 7, 11,{ "Gains #2+3#- Mult", "when #5Booster Pack#-", "is skipped", "", "", ""}},
    { JOKER_TYPE_MADNESS          ,"Madness",               7, JOKER_RARITY_UNCOMMON, true , 8, 11,{ "Gain #c#1x0.5#- Mult", "#5destroy#- Joker when", "Blind is selected", "", "", ""}},
    { JOKER_TYPE_SQUARE_JOKER     ,"Square Joker",          4, JOKER_RARITY_COMMON,   true , 9, 11,{ "Gains #3+4#- Chips", "if played hand has", "exactly #54#- cards", "", "", ""}},
    { JOKER_TYPE_SEANCE           ,"Seance",                6, JOKER_RARITY_UNCOMMON, true , 0, 12,{ "If hand is a", "#5Straight Flush#-,", "create #5Spectral#- card", "", "", ""}},
    { JOKER_TYPE_RIFF_RAFF        ,"Riff Raff",             6, JOKER_RARITY_COMMON,   true , 1, 12,{ "When #5Blind#- is selected,", " create #52#- #3Common#- #5Jokers#-", "", "", "", ""}},
    { JOKER_TYPE_VAMPIRE          ,"Vampire",               7, JOKER_RARITY_UNCOMMON, true , 2, 12,{ "Gains #c#1x0.1#- Mult", "per scored #5Enhanced#-", "card; removes Enh.", "", "", ""}},
    { JOKER_TYPE_SHORTCUT         ,"Shortcut",              7, JOKER_RARITY_UNCOMMON, true , 3, 12,{ "#5Straights#- can be", "made with gaps", "of #51 rank#-", "", "", ""}},
    { JOKER_TYPE_HOLOGRAM         ,"Hologram",              7, JOKER_RARITY_UNCOMMON, true , 4, 12,{ "Gains #c#1x0.25#- Mult", "each time a card", "is added to deck", "", "", ""}},
    ...
    { JOKER_TYPE_CLOUD_9          ,"Cloud 9",               7, JOKER_RARITY_UNCOMMON, true , 7, 12,{ "Earn #5$1#- per #59#-", "in your #5full deck#-", "at end of round", "", "", ""}},
    ...
    { JOKER_TYPE_OBELISK          ,"Obelisk",               8, JOKER_RARITY_RARE,     true , 9, 12,{ "Gains #c#1x0.2#- Mult", "per consecutive hand", "without top hand", "", "", ""}},
    { JOKER_TYPE_MIDAS_MASK       ,"Midas Mask",            7, JOKER_RARITY_UNCOMMON, true , 0, 13,{ "All played #5face#- cards", "become #5Gold#- cards", "when scored", "", "", ""}},
    { JOKER_TYPE_LUCHADOR         ,"Luchador",              5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Sell this card to", "disable the current", "#5Boss Blind#-", "", "", ""}},
    { JOKER_TYPE_PHOTOGRAPH       ,"Photograph",            5, JOKER_RARITY_COMMON,   true , 2, 13,{ "First played #5face#-", "card gives #c#1x2#- Mult", "when scored", "", "", ""}},
    { JOKER_TYPE_GIFT_CARD        ,"Gift Card",             6, JOKER_RARITY_UNCOMMON, true , 3, 13,{ "Add #5$1#- sell value", "to all #5Jokers#-", "and #5Consumables#-", "", "", ""}},
    { JOKER_TYPE_TURTLE_BEAN      ,"Turtle Bean",           6, JOKER_RARITY_UNCOMMON, true , 4, 13,{ "#5+5#- hand size,", "reduces by #21#-", "each round", "", "", ""}},
    { JOKER_TYPE_EROSION          ,"Erosion",               6, JOKER_RARITY_UNCOMMON, true , 5, 13,{ "#2+4#- Mult for each", "card below", "#5[the deck's starting size]#-", "in your full deck", "(Currently #2+#j#- Mult)", ""}},
    { JOKER_TYPE_RESERVED_PARKING ,"Reserved Parking",     5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Each #5face card#-", "in hand has", "#41 in 2#- chance of #5$1#-", "", "", ""}},
    { JOKER_TYPE_MAIL_IN_REBATE   ,"Mail-in Rebate",       5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Earn #5$3#- per", "discarded #5#j#- card,", "rank changes each round", "", "", ""}},
    ...
    { JOKER_TYPE_HALLUCINATION    ,"Hallucination",        5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "#41 in 2#- chance to", "create #5Tarot#- when", "#5Booster Pack#- opened", "", "", ""}},
    { JOKER_TYPE_FORTUNE_TELLER   ,"Fortune Teller",       5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "#2+1#- Mult per", "#5Tarot#- card used", "this run", "", "", ""}},
    ...
    { JOKER_TYPE_STONE_JOKER      ,"Stone Joker",          5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Gives #3+25#- Chips", "per #5Stone Card#-", "in full deck", "", "", ""}},
    { JOKER_TYPE_GOLDEN_JOKER     ,"Golden Joker",          6, JOKER_RARITY_COMMON,   true,  9,  2,{ "Earn #5$4#-", "at end of round", "", "", "", ""}},
    { JOKER_TYPE_LUCKY_CAT        ,"Lucky Cat",             6, JOKER_RARITY_UNCOMMON, true , 5, 14,{ "This Joker gains", "#c#1x0.25#- Mult every time", "a #5Lucky#- card", "#4successfully#- triggers", "(Currently #c#1x#j#- Mult)", ""}},
    { JOKER_TYPE_BASEBALL_CARD    ,"Baseball Card",        5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "#5Uncommon#- Jokers", "each give", "#c#1x1.5#- Mult", "", "", ""}},
    { JOKER_TYPE_BULL             ,"Bull",                  6, JOKER_RARITY_UNCOMMON, true , 7, 14,{ "#3+2#- Chips for each", "#5$1#- you have", "(Currently #3+#j#- Chips)", "", "", ""}},
    { JOKER_TYPE_DIET_COLA        ,"Diet Cola",            5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Sell this card to", "create a free", "#5Double Tag#-", "", "", ""}},
    { JOKER_TYPE_TRADING_CARD     ,"Trading Card",         5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "If first discard", "has only #51#- card,", "destroy it for #5$3#-", "", "", ""}},
    { JOKER_TYPE_FLASH_CARD       ,"Flash Card",           5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Gains #2+2#- Mult", "per shop reroll", "(Currently #2+0#- Mult)", "", "", ""}},
    ...
    { JOKER_TYPE_RAMEN            ,"Ramen",                5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "#c#1x2#- Mult,", "loses #c#1x0.01#- Mult", "per card discarded", "", "", ""}},
    ...
    { JOKER_TYPE_SELTZER          ,"Seltzer",              5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Retrigger all", "played cards for", "next #510#- hands", "", "", ""}},
    { JOKER_TYPE_CASTLE           ,"Castle",               5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Gains #3+3#- Chips", "per discarded card", "of current suit", "", "", ""}},
    { JOKER_TYPE_SMILEY_FACE      ,"Smiley Face",           4, JOKER_RARITY_COMMON,   true,  6, 15,{ "Played #5face#- cards", "give #2+5#- Mult", "when scored", "", "", ""}},
    { JOKER_TYPE_CAMPFIRE         ,"Campfire",             5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Gains #c#1x0.25#- Mult", "per card sold;", "resets at Boss Blind", "", "", ""}},
    { JOKER_TYPE_GOLDEN_TICKET    ,"Golden Ticket",         5, JOKER_RARITY_COMMON,   true , 5,  3,{ "Played #5Gold#- cards", "earn #5$4#- when scored", "", "", "", ""}},
    { JOKER_TYPE_MR_BONES         ,"Mr. Bones",            5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Prevents death", "if scored chips", "are #525%#- of blind", "", "", ""}},
    ...
    { JOKER_TYPE_CERTIFICATE      ,"Certificate",          5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Round start: add", "random #5playing card#-", "with random seal", "", "", ""}},
    ...
    { JOKER_TYPE_THROWBACK        ,"Throwback",            5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "#c#1x0.25#- Mult per", "#5Blind skipped#-", "this run", "", "", ""}},
    ...
    { JOKER_TYPE_GLASS_JOKER      ,"Glass Joker",          5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Gains #c#1x0.75#- Mult", "per #5Glass Card#-", "destroyed", "", "", ""}},
    { JOKER_TYPE_SHOWMAN          ,"Showman",              5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "#5Joker, Tarot,#-", "#5Planet, Spectral#-", "cards may repeat", "", "", ""}},
    { JOKER_TYPE_FLOWERPOT        ,"Flower Pot",           5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "#c#1x3#- Mult if hand", "contains a card of", "each #5suit#-", "", "", ""}},
    { JOKER_TYPE_BLUEPRINT        ,"Blueprint",            10, JOKER_RARITY_RARE,     true , 0,  3,{ "Copies ability of", "#5Joker#- to the right", "", "", "", ""}},
    { JOKER_TYPE_WEE_JOKER        ,"Wee Joker",            5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Gains #3+8#- Chips", "when a played", "#52#- is scored", "", "", ""}},
    { JOKER_TYPE_MERRY_ANDY       ,"Merry Andy",            7, JOKER_RARITY_UNCOMMON, true , 8,  0,{ "#2+3#- discards each", "round,", "#2-1#- hand size", "", "", ""}},
    { JOKER_TYPE_OOPS_ALL_6S      ,"Oops! All 6s",          4, JOKER_RARITY_UNCOMMON, true , 5,  6,{ "Doubles all #5listed#-", "probabilities", "", "", "", ""}},
    { JOKER_TYPE_THE_IDOL         ,"The Idol",             5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Each played #5Ace#-", "of random suit gives", "#c#1x2#- Mult", "", "", ""}},
    { JOKER_TYPE_SEEING_DOUBLE    ,"Seeing Double",        5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "#c#1x2#- Mult if hand", "has scoring #5Club#-", "and non-#5Club#- card", "", "", ""}},
    { JOKER_TYPE_MATADOR          ,"Matador",              5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Earn #5$8#- if hand", "triggers #5Boss Blind#-", "ability", "", "", ""}},
    { JOKER_TYPE_HIT_THE_ROAD     ,"Hit the Road",         5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Gains #c#1x0.5#- Mult", "per #5Jack#-", "discarded this round", "", "", ""}},
    ...
    { JOKER_TYPE_INVISIBLE_JOKER  ,"Invisible Joker",      5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "After #52#- rounds,", "sell to #5Duplicate#-", "a random Joker", "", "", ""}},
    { JOKER_TYPE_BRAINSTORM       ,"Brainstorm",           10, JOKER_RARITY_RARE,     true,  7,  7,{ "Copies the ability", "of leftmost #5Joker#-", "", "", "", ""}},
    { JOKER_TYPE_SATELLITE        ,"Satellite",            5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Earn #5$1#- at end", "of round per unique", "#5Planet#- card used", "", "", ""}},
    { JOKER_TYPE_SHOOT_THE_MOON   ,"Shoot the Moon",       5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Each #5Queen#-", "held in hand", "gives #2+13#- Mult", "", "", ""}},
    { JOKER_TYPE_DRIVERS_LICENSE  ,"Driver's License",     5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "#c#1x3#- Mult with", "16+ #5Enhanced#-", "cards in deck", "", "", ""}},
    { JOKER_TYPE_CARTOMANCER      ,"Cartomancer",          5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Create a #5Tarot#-", "when Blind selected", "(must have room)", "", "", ""}},
    { JOKER_TYPE_ASTRONOMER       ,"Astronomer",           5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "All #5Planet#- cards", "and Celestial Packs", "in shop are #5free#-", "", "", ""}},
    { JOKER_TYPE_BURNT_JOKER      ,"Burnt Joker",          5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Upgrade level of", "first #5discarded#-", "poker hand each round", "", "", ""}},
    { JOKER_TYPE_BOOTSTRAPS       ,"Bootstraps",           5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "#2+2#- Mult per", "#5$5#- you have", "(Currently #2+0#- Mult)", "", "", ""}},
    { JOKER_TYPE_CANIO            ,"Canio",                5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Gains #c#1x1#- Mult", "when #5face card#-", "is destroyed", "", "", ""}},
    { JOKER_TYPE_TRIBOULET        ,"Triboulet",            5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Played #5Kings#-", "and #5Queens#- give", "#c#1x2#- Mult scored", "", "", ""}},
    { JOKER_TYPE_YORICK           ,"Yorick",               5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Gains #c#1x1#- Mult", "every #523#- cards", "discarded", "", "", ""}},
    { JOKER_TYPE_CHICOT           ,"Chicot",               5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Disables effect of", "every #5Boss Blind#-", "", "", "", ""}},
    { JOKER_TYPE_PERKEO           ,"Perkeo",               5, JOKER_RARITY_UNCOMMON, true , 1, 13,{ "Creates a #d#1Negative#-", "copy of random", "#5consumable#- card", "", "", ""}}
};
